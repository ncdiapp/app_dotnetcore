...
VALUES (
    'app-builder',
    'add_search_to_menu',
    'Step 6 — Add an existing search (or saved search) to the application''s main navigation menu. Call this after create_search_view if the search was not automatically added to the menu.',
    '{"searchId":{"type":"integer","description":"The ID of the search or saved search to add to the menu","required":true},"menuName":{"type":"string","description":"Display label for the menu item, e.g. Sales Orders","required":true},"isSavedSearch":{"type":"boolean","description":"Set true if searchId refers to a saved search; false for a regular search"}}',
    'BuiltIn',
...
VALUES (
    ...
    '{"saasApplicationId":{"type":"integer","description":"The SaasApplicationId returned by create_app_package. Required to link transactions to the correct app."},"transactionName":{"type":"string","description":"Display name for the root transaction, e.g. Sales Order Management."}}',
    'BuiltIn',
...
VALUES (
    ...
    '{"requirements":{"type":"string","description":"Detailed natural-language description of what to build, including entity names, fields, and relationships.","required":true},"saasApplicationId":{"type":"integer","description":"The SaasApplicationId returned by create_app_package. Required to link the transaction to the correct application."},"appName":{"type":"string","description":"Optional descriptive name for the root transaction, e.g. Sales Order Management"},"entityMapJson":{"type":"string","description":"JSON object mapping FK column names to EntityDataSource IDs — wires dropdowns at creation time. Obtain entity IDs from list_entity_data_sources."}}',
    'BuiltIn',
...
VALUES (
    ...
    '{"tableName":{"type":"string","description":"Name of the existing database table","required":true},"saasApplicationId":{"type":"integer","description":"The SaasApplicationId returned by create_app_package, to link this transaction to the correct app."},"schemaOwner":{"type":"string","description":"Schema owner, e.g. dbo. Leave empty to use the data source default."}}',
    'BuiltIn',
