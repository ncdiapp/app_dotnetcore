...
-- =============================================================================
-- 6_PlmDw_CleanupBomColorwayStaging.sql - Template 3351
...
DECLARE @PlmTabId        INT           = 4229;   -- host tab id (e.g. 4246) for Tab_{id} integration lookup
...
DECLARE @PlmTabId        INT           = 4230;   -- host tab id (e.g. 4246) for Tab_{id} integration lookup
DECLARE @DryRun          BIT           = 0;
DECLARE @RequireGrandchildRows BIT     = 1;     -- refuse cleanup if grandchild empty
