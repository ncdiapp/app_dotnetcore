...
-- Template 3351 â€” BOM Grid 3167 / Block 5052 â†’ Plm_ArtworkGrandColorway
...
DECLARE @DwGridTable           NVARCHAR(256) = N'PLM_DW_Grid_Artwork_BOM_prod_3167';   -- e.g. PLM_DW_Grid_Artwork_BOM_prod_3167
DECLARE @HostAppTable          NVARCHAR(128) = N'Artwork_BOM_prod';   -- e.g. Artwork_BOM_prod (prefix applied)
DECLARE @GrandchildAppTable    NVARCHAR(128) = N'ArtworkGrandColorway';   -- e.g. ArtworkGrandColorway
