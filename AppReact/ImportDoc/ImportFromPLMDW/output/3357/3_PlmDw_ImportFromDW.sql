...
DECLARE @PlmTemplateId     INT           = 3357;                   -- <<< USER SETTING â€” scope refs: pdmProductTemplate.TemplateID
...
WHERE m.[FieldKind] IN (N''TabField'', N''GridColumn'')
  AND m.[AppTableName] IN (N''@P@Color_Patette_Header'', N''@P@ProductDesignColorGrid'')
