...
DECLARE @PlmTemplateId     INT           = 3354;                   -- <<< USER SETTING â€” scope refs: pdmProductTemplate.TemplateID
...
WHERE m.[FieldKind] IN (N''TabField'', N''GridColumn'')
  AND m.[AppTableName] IN (N''@P@Label_Header'', N''@P@Label_Info'', N''@P@SizeRunDetailGrid'', N''@P@DimensionDetailGrid'', N''@P@ProductDesignColorGrid'', N''@P@MaterialCosting_reg'', N''@P@Trims_Tracking'')
