...
SET @sql = N'DELETE FROM dbo.' + QUOTENAME(@MappingTable)
    + N' WHERE [AppTableName] IN (N''@P@ReferenceBasicInfo'', N''@P@Style_Header_V2K_ERP'', N''@P@Grading'', N''@P@How_to_Measure_Instructions'', N''@P@Fit_Summary'', N''@P@FitRoundInfo'', N''@P@SizeRunDetailGrid'', N''@P@DimensionDetailGrid'', N''@P@Fit_Comment_Grid_reg'');';
SET @sql = REPLACE(@sql, N'@P@', @TablePrefix);
EXEC sp_executesql @sql;

-- FieldMapping INSERT batch 1 (208 row(s))
SET @sql = N'
...
VALUES
        ...
        (N''@P@Fit_Comment_Grid_reg'', N''Date'', N''PLM_DW_Grid_Fit_Comment_Grid_reg_3004'', N''Date_4231'', NULL, 4231, 3219, 3004, 4231, NULL, NULL, N''GridColumn'', 7, NULL, N''datetime''),
        (N''@P@Fit_Comment_Grid_reg'', N''Comments'', N''PLM_DW_Grid_Fit_Comment_Grid_reg_3004'', N''Comments_4233'', NULL, 4233, 3219, 3004, 4233, NULL, NULL, N''GridColumn'', 4, NULL, N''nvarchar''),
        (N''@P@Fit_Comment_Grid_reg'', N''Image'', N''PLM_DW_Grid_Fit_Comment_Grid_reg_3004'', N''Image_4234_FK_tblSketch'', NULL, 4234, 3219, 3004, 4234, NULL, N''tblSketch'', N''GridColumn'', 5, 11, N''int''),
        (N''@P@Fit_Comment_Grid_reg'', N''_4230'', N''PLM_DW_Grid_Fit_Comment_Grid_reg_3004'', N''_4230'', NULL, NULL, 3219, 3004, NULL, NULL, NULL, N''GridColumn'', 2, NULL, N''float''),
