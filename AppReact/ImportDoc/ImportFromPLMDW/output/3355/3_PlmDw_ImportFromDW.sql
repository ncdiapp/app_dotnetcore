...
DECLARE @PlmTemplateId     INT           = 3355;                   -- <<< USER SETTING â€” scope refs: pdmProductTemplate.TemplateID
...
WHERE m.[FieldKind] IN (N''TabField'', N''GridColumn'')
  AND m.[AppTableName] IN (N''@P@Packaging_Header'', N''@P@Packaging_Info'', N''@P@SizeRunDetailGrid'', N''@P@DimensionDetailGrid'', N''@P@ProductDesignColorGrid'', N''@P@Trims_Tracking'')
