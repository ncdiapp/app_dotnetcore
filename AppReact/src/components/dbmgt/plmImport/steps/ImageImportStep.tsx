...
const ImageImportStep: React.FC<ImageImportStepProps> = ({ state }) => {
  ...
  return (
    <div className="w-full h-full flex flex-col overflow-hidden">
      <div className={`flex items-center justify-between px-3 py-2 mb-1 ${theme.mainContentSection}`}>
        <div>
          <h2 className={`text-sm font-semibold ${theme.title}`}>Step 5 — Image Import</h2>
      ...
      <div className={`w-full h-1 flex-auto overflow-auto px-5 py-5 ${theme.mainContentSection}`}>
        <div className={`rounded border p-4 mb-4 ${theme.inputBox}`}>
          ...
          <div className={`text-xs leading-6 ${theme.menu_secondary}`}>
            <div>Images: OriginalImage → <code>/original/&#123;guid&#125;</code>, SketchImage → <code>/regular/&#123;guid&#125;</code>, Thumbnail → <code>/thumbnail/&#123;guid&#125;</code>.</div>
...
export default ImageImportStep;
