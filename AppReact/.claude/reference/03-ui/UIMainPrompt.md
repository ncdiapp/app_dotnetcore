...
- **Main Prompt**: See `../MainPrompt.md` for overall project structure
- **Migration Guides**: See `../02-migration/` for AngularJS to React conversion
- **Architecture**: See `../04-architecture/` for system design solutions
- **Specific Component Rules**: See `../05-Specific-Component-Rule/` for specific component implementation details
