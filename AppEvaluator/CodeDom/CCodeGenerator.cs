...
namespace DynamicAssemblies
{
    public class CCodeGenerator
    {
        ...
        CodeCompileUnit _ContainerUnitMyassembly;

        CodeNamespace _Mynamespace;
        CodeTypeDeclaration _Myclass;

        private const string outputFileName = "SampleCode.cs";

        public void CreateNamespace()
        {
            this._Mynamespace = new CodeNamespace("mynamespace");
        }
        ...
        {
           this. _Myclass = new CodeTypeDeclaration();
            //Assign a name for the class
           this._Myclass.Name = "CMyclass";
           this._Myclass.IsClass = true;
            //Set the Access modifier.
           this._Myclass.Attributes = MemberAttributes.Public;
            //Add the newly created class to the namespace
           this._Mynamespace.Types.Add(_Myclass);
        }
        ...
        public void CreateMember()
        {
            ...
            this._Myclass.Members.Add(mymemberfield);
        }
        ...
        public void CreateProperty()
        {
            ...
            this._Myclass.Members.Add(mymemberproperty);
        ...
        public void CreateMethod()
        {
            ...
            this._Myclass.Members.Add(mymethod);
        }
        ...
        public void CreateEntryPoint()
        {
            ...
            _Myclass.Members.Add(mymain);
        }

        public void SaveAssembly()
        {
            //Create a new object of the global CodeCompileUnit class.
            _ContainerUnitMyassembly = new CodeCompileUnit();
            //Add the namespace to the assembly.
            _ContainerUnitMyassembly.Namespaces.Add(_Mynamespace);
            ...
            comparam.OutputAssembly = @".\HelloWorld.exe";
            ...
            CompilerResults compres = ccp.CompileAssemblyFromDom(comparam, _ContainerUnitMyassembly);
        ...
        public void GenerateCSharpCode(string fileName)
        {
            ...
            {
                provider.GenerateCodeFromCompileUnit(   _ContainerUnitMyassembly, sourceWriter, options);
            }
        }

        public static void Main1CcodeGen()
        {
          ...
          // cg.ex
            cg.GenerateCSharpCode("Test1.cs");
        }
    }
}