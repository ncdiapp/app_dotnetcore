...
using System.Linq;
//using APP.Persistence.Common.Properties;
...

{
    ...
    public static class StringUtil
    {
        ...
        public static string NormalizeIndentation(string code)
        {
            ...
            foreach (var line in lines)
            {
                sb.AppendLine(StringUtil.ReplaceStringInstance(line, strip, "", 1, false));
            }
        ...
        //    if ((hex.Length % 2) != 0)
        //        throw new ArgumentException(String.Format(Resource.InvalidHexStringLength, hex.Length));
        ...
        //    throw new ArgumentException(Resource.InvalidHexDigit + c);
        //}
        ...
        {
            return StringUtil.ExtractString(propertyString, "<" + key + ">", "</" + key + ">");
        }
        ...
        {
            string extract = StringUtil.ExtractString(propertyString, "<" + key + ">", "</" + key + ">");
