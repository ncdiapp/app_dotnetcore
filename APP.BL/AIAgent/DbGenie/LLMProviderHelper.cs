...
namespace App.BL.DbGenie
{
    ...
    {
        // Default models — tenant setting wins, then appsettings.json, then hardcoded fallback
        public static string OpenAIDefaultModel    => AIConfigSettingBL.GetOpenAIModel();
        public static string GeminiDefaultModel    => AIConfigSettingBL.GetGeminiModel();
        public static string AnthropicDefaultModel => AIConfigSettingBL.GetAnthropicModel();
        ...
        /// <summary>
        /// Returns the active LLM provider — tenant setting first, then appsettings.json.
        /// </summary>
        public static EmLLMProvider GetConfiguredProvider()
        {
            var providerName = AIConfigSettingBL.GetProvider();
            if (Enum.TryParse(providerName, true, out EmLLMProvider provider))
                return provider;
            return EmLLMProvider.Gemini;
        }

        /// <summary>
        /// Returns the active LLM API key — tenant setting first, then appsettings.json.
        /// </summary>
        public static string GetConfiguredApiKey()
        {
            return AIConfigSettingBL.GetApiKey();
        }
