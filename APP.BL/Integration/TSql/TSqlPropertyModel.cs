...
namespace ExchangeBL
{
    ...
    public class TSqlPropertyModel : PropertyModelBase
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="TSqlPropertyModel"/> class.</summary>
        /// <param name="classTemplateModel">The class template model.</param>
        /// <param name="property">The property.</param>
        /// <param name="typeResolver">The type resolver.</param>
        /// <param name="settings">The settings.</param>
        public TSqlPropertyModel(
            TSqlTableModel classTemplateModel,
            JsonSchemaProperty property,
            TSqlTypeResolver typeResolver,
            TSqlGeneratorSettings settings)
        ...
        /// <summary>
        /// if property can be exportted to sql seerver, remove Mapping__Key__
        /// </summary>
        public bool IsSqlColumn => !PropertyName.StartsWith(_settings.MappingKeyPrefix) && !PropertyName.StartsWith(_settings.MappingUniquePrefix);
        /// <summary>
        /// remove "Mapping__" from propertyname
        /// </summary>
        public string ColumnName => PropertyName.Replace(_settings.MappingPrefix, "");
        /// <summary>
        /// column is key or foregin key
        /// </summary>
        public bool IsKeyColumn => PropertyName.StartsWith(_settings.MappingKeyPrefix) || PropertyName.Equals(_settings.MappingForeginKeyId);
        ...
        public string KeyColumnName
        {
            get
            {
                if (PropertyName.StartsWith(_settings.MappingKeyPrefix))
                {
                    return PropertyName.Replace(_settings.MappingKeyPrefix, "");
                }
                else
                {
                    return PropertyName;
