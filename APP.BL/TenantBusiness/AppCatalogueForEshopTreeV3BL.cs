...
//namespace App.BL
//{
//    public static class AppCatalogueForEshopTreeV3BL
//    {
...
//            Dictionary<int, List<AppSearchViewFieldExDto>> dictOptionLevelSearchField = GetDictTreeViewLevelNodeList(cardDetailSearchViewExDto);
...
//        internal static Dictionary<int, List<AppSearchViewFieldExDto>> GetDictTreeViewLevelNodeList(AppSearchViewExDto aAppSearchViewExDto)
//        {
...
//        internal static void FirstlevelTree(AppCatalogueTreeDto oneTreeRootFolder, DataTable dataTable, string columnIdColumnName, string columnDislay, string columnImage)
//        {
...
//        internal static void SecondLevelTree(AppCatalogueTreeDto oneTreeRootFolder, DataTable dataTable, List<string> levelNodeIdColumnName, string columnIdColumnName, string columnDislay, string columnImage)
//        {
...
//        internal static void ThirdLevelTree(AppCatalogueTreeDto oneTreeRootFolder, DataTable dataTable, List<string> levelNodeIdColumnName, string columnIdColumnName, string columnDislay, string columnImage)
//        {
//            foreach (AppCatalogueTreeDto firstlevelDto in oneTreeRootFolder.Children)
//            {
//                // Select("Size >= 230 AND Sex = 'm'"
...
//        internal static void FourthLevelTree(AppCatalogueTreeDto oneTreeRootFolder, DataTable dataTable, List<string> levelNodeIdColumnName, string columnIdColumnName, string columnDislay, string columnImage)
//        {
//            foreach (AppCatalogueTreeDto firstlevelDto in oneTreeRootFolder.Children)
//            {
//                // Select("Size >= 230 AND Sex = 'm'"
...
//        internal static void FivelevelTree(AppCatalogueTreeDto oneTreeRootFolder, DataTable dataTable, List<string> levelNodeIdColumnName, string columnIdColumnName, string columnDislay, string columnImage)
//        {
//            foreach (AppCatalogueTreeDto firstlevelDto in oneTreeRootFolder.Children)
//            {
//                // Select("Size >= 230 AND Sex = 'm'"
