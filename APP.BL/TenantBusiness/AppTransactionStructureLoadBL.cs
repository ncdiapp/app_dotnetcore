       ...
       .ToDictionary(o => o.Key.ToString(),
        ...
        private static void PorcessOneUnit(AppTransactionStructureDto transactionStructureDto, Dictionary<int, string> dictAllFiledIdDataBaseFileName, AppTransactionUnitExDto aTransactionUnit)
        {
                    ...
                    || isChildUnitPivotColumns))
            {
                ...
                appPivotDto.PivotRowFields = aTransactionUnit.AppTransactionFieldList.Where(o => o.IsPivotRow.HasValue && o.IsPivotRow.Value).Select(o => new AppTransactionFieldDto() { Id = o.Id, DataBaseFieldName = o.DataBaseFieldName, DisplayName = o.DisplayName, EntityId = o.EntityId, ControlType = o.ControlType, Nbdecimal = o.Nbdecimal, IsVisible = o.IsVisible }).ToList();
                appPivotDto.PivotColumnFields = aTransactionUnit.AppTransactionFieldList.Where(o => o.IsPivotColumn.HasValue && o.IsPivotColumn.Value).Select(o => new AppTransactionFieldDto() { Id = o.Id, DataBaseFieldName = o.DataBaseFieldName, DisplayName = o.DisplayName, EntityId = o.EntityId, ControlType = o.ControlType, Nbdecimal = o.Nbdecimal, IsVisible = o.IsVisible }).ToList();
                appPivotDto.PivotValueFields = aTransactionUnit.AppTransactionFieldList.Where(o => o.IsPivotValue.HasValue && o.IsPivotValue.Value || o.IsPrimaryKey || o.IsLinkToParentPrimaryKey).Select(o => new AppTransactionFieldDto() { Id = o.Id, DataBaseFieldName = o.DataBaseFieldName, DisplayName = o.DisplayName, EntityId = o.EntityId, ControlType = o.ControlType, Nbdecimal = o.Nbdecimal, IsVisible = o.IsVisible }).ToList();
                appPivotDto.AllFields = aTransactionUnit.AppTransactionFieldList.Select(o => new AppTransactionFieldDto() { Id = o.Id, DataBaseFieldName = o.DataBaseFieldName, DisplayName = o.DisplayName, EntityId = o.EntityId, ControlType = o.ControlType, Nbdecimal = o.Nbdecimal, IsVisible = o.IsVisible }).ToList();
