...
namespace App.BL
{
    ...
    public static class AppTailwindConstants
    {
       
        public static readonly dynamic StyleConstants = JsonConvert.DeserializeObject<dynamic>(
            @"
                {
                    'box-sizing': {
        ...
        public static readonly dynamic ColorConstants = JsonConvert.DeserializeObject<dynamic>(
           @"
                [
                    '#000',
                    '#fff',
        ...
        public static readonly Dictionary<string, string> DictCssPropertyAndTwArbitraryValue = new Dictionary<string, string>
        {
            // Spacing
            { "padding", "p-[value]" },
            ...
            // Borders
            { "border", "border-[value]" },
            { "border-top", "border-t-[value]" },
            { "border-right", "border-r-[value]" },
            { "border-bottom", "border-b-[value]" },
            { "border-left", "border-l-[value]" },
            { "border-radius", "rounded-[value]" },
            { "border-top-left-radius", "rounded-tl-[value]" },
            { "border-top-right-radius", "rounded-tr-[value]" },
            { "border-bottom-right-radius", "rounded-br-[value]" },
            { "border-bottom-left-radius", "rounded-bl-[value]" },
            ...
            // Gradients
            { "background-image", "bg-gradient-to-t/[value]" }
        };
