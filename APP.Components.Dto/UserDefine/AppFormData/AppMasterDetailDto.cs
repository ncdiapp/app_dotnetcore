...
namespace APP.Components.EntityDto
{
    ...
    public class AppMasterDetailDto
    {
        ...
        [DataMember]
        public bool IsNeedToCloseFormWindow
        {
            get;
            set;
        }
        ...
        // Key: TranscationFiledId.ToString()
        [DataMember(EmitDefaultValue = false)]
        public Dictionary<String, String> DictCascadingFieldIdAndLabel
        {
            get;
            set;
        }
        ...
        [DataMember]
        public int? CurrentAutoCompleteFieldId
        {
            get;
            set;
        }
        ...
        //[DataMember]
        //public int? CurrentAutoCompleteUnitId
        //{
        //    get;
        //    set;
        //}
        ...
        [DataMember]
        public string CurrentAutoCompleteFieldQueryText
        {
            get;
            set;
        }
        ...
        [DataMember]
        public bool IsGetAllDataSourceItemsOfSearchAbleDDLField
        {
            get;
            set;
        }
        ...
        [DataMember(EmitDefaultValue = false)]
        public int? DebugWorkflowRootChildCommandId
        {
            get;
            set;
        }
        ...
        [DataMember(EmitDefaultValue = false)]
        public bool IsApiIntegrationTransaction
        {
            get;
            set;
        }
        ...
        [DataMember(EmitDefaultValue = false)]
        public AppMasterDetailDto DataTransferFromMasterDetailDto
        {
            get;
            set;
        }
        ...
        [DataMember(EmitDefaultValue = false)]
        public AppChildDataDto DataTransferFromListEditRowDto
        {
            get;
            set;
        }
        ...
        [DataMember(EmitDefaultValue = false)]
        public AppChildDataDto CurrentEditRowDto
        {
            get;
            set;
        }
        ...
        public AppListDataDto OrgAppListDataDto
        {
            get;
            set;
        }
        ...
        public int? CommandForeachLoopChildUnitId
        {
            get;
            set;
        }
        ...
        public AppChildDataDto CommandForeachLoopToRowData
        {
            get;
            set;
        }
        ...
        [IgnoreDataMember]
        public AppFileDto UploadedFileDto
        {
            get;
            set;
        }
        ...
        [DataMember(EmitDefaultValue = false)]
        public bool IsRootCommandFormData
        {
            get;
            set;
        }
