...
{
    /// <summary>
    /// DTO class for the  Extend Relation Entity 'AppWorkflow'.
    /// </summary>
    
    [DataContract(Namespace = ContractNamespaces.Dto)]
    public partial class AppWorkflowExDto : AppWorkflowDto 
    {

     	#region Static Name Properties Declaration
    
            public static readonly string AppWorkFlowStepListProperty = ObjectInfoHelper.GetName<AppWorkflowExDto,  ObservableSet<AppWorkFlowStepExDto>>(o=>o.AppWorkFlowStepList); 
