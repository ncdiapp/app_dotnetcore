...
{
    /// <summary>
    /// DTO class for the  Extend Relation Entity 'AppSefolderResource'.
    /// </summary>
    
    [DataContract(Namespace = ContractNamespaces.Dto)]
    public partial class AppSefolderResourceExDto : AppSefolderResourceDto 
    {

     	#region Static Name Properties Declaration
    
 
            public static readonly string ForeignAppSecurityGroupProperty = ObjectInfoHelper.GetName<AppSefolderResourceExDto,  AppSecurityGroupExDto>(o=>o.ForeignAppSecurityGroupExDto);
            public static readonly string ForeignAppSecurityUserProperty = ObjectInfoHelper.GetName<AppSefolderResourceExDto,  AppSecurityUserExDto>(o=>o.ForeignAppSecurityUserExDto);
            public static readonly string ForeignAppSefolderProperty = ObjectInfoHelper.GetName<AppSefolderResourceExDto,  AppSefolderExDto>(o=>o.ForeignAppSefolderExDto); 

        
        #endregion
	
	
        public AppSefolderResourceExDto()
        {        
        }
