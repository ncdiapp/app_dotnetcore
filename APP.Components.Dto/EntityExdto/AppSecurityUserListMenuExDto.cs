...
{
    /// <summary>
    /// DTO class for the  Extend Relation Entity 'AppSecurityUserListMenu'.
    /// </summary>
    
    [DataContract(Namespace = ContractNamespaces.Dto)]
    public partial class AppSecurityUserListMenuExDto : AppSecurityUserListMenuDto 
    {

     	#region Static Name Properties Declaration
    
 
            public static readonly string ForeignAppListMenuProperty = ObjectInfoHelper.GetName<AppSecurityUserListMenuExDto,  AppListMenuExDto>(o=>o.ForeignAppListMenuExDto);
            public static readonly string ForeignAppSecurityGroupProperty = ObjectInfoHelper.GetName<AppSecurityUserListMenuExDto,  AppSecurityGroupExDto>(o=>o.ForeignAppSecurityGroupExDto);
            public static readonly string ForeignAppSecurityUserProperty = ObjectInfoHelper.GetName<AppSecurityUserListMenuExDto,  AppSecurityUserExDto>(o=>o.ForeignAppSecurityUserExDto); 

        
        #endregion
	
	
        public AppSecurityUserListMenuExDto()
        {        
        }
