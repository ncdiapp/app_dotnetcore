...
{
    /// <summary>
    /// DTO class for the  Extend Relation Entity 'AppCurrentUserFavouriteFolderOrFile'.
    /// </summary>
    
    [DataContract(Namespace = ContractNamespaces.Dto)]
    public partial class AppCurrentUserFavouriteFolderOrFileExDto : AppCurrentUserFavouriteFolderOrFileDto 
    {

     	#region Static Name Properties Declaration
    
 
            public static readonly string ForeignAppFileProperty = ObjectInfoHelper.GetName<AppCurrentUserFavouriteFolderOrFileExDto,  AppFileExDto>(o=>o.ForeignAppFileExDto);
            public static readonly string ForeignAppSecurityUserProperty = ObjectInfoHelper.GetName<AppCurrentUserFavouriteFolderOrFileExDto,  AppSecurityUserExDto>(o=>o.ForeignAppSecurityUserExDto);
            public static readonly string ForeignAppSefolderProperty = ObjectInfoHelper.GetName<AppCurrentUserFavouriteFolderOrFileExDto,  AppSefolderExDto>(o=>o.ForeignAppSefolderExDto); 

        
        #endregion
	
	
        public AppCurrentUserFavouriteFolderOrFileExDto()
        {        
        }
