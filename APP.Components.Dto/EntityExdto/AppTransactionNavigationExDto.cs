...
{
    /// <summary>
    /// DTO class for the  Extend Relation Entity 'AppTransactionNavigation'.
    /// </summary>
    
    [DataContract(Namespace = ContractNamespaces.Dto)]
    public partial class AppTransactionNavigationExDto : AppTransactionNavigationDto 
    {

     	#region Static Name Properties Declaration
    
 
            public static readonly string ForeignAppSearchProperty = ObjectInfoHelper.GetName<AppTransactionNavigationExDto,  AppSearchExDto>(o=>o.ForeignAppSearchExDto);
            public static readonly string ForeignAppSearchViewProperty = ObjectInfoHelper.GetName<AppTransactionNavigationExDto,  AppSearchViewExDto>(o=>o.ForeignAppSearchViewExDto);
            public static readonly string ForeignAppTransactionProperty = ObjectInfoHelper.GetName<AppTransactionNavigationExDto,  AppTransactionExDto>(o=>o.ForeignAppTransactionExDto); 

        
        #endregion
	
	
        public AppTransactionNavigationExDto()
        {        
        }
