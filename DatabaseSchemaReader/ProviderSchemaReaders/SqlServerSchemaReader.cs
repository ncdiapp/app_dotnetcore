...
namespace DatabaseSchemaMrg.ProviderSchemaReaders
{
    ...
    {
		public static readonly string QueryTableAndSchemaOwner = @"SELECT * FROM INFORMATION_SCHEMA.SCHEMATA ";
		public static readonly string QueryCurrentUserSchema = @"SELECT SCHEMA_NAME()";
		...
		//private static string GetNotBuitInSchemaCommand()
		//{
		//	//information_schema.check_constraints doesn't have table, so we join to table constraints
		//	const string sqlCommand = @"SELECT * FROM INFORMATION_SCHEMA.SCHEMATA  where  SCHEMA_OWNER not  in 
		//				(
		//				'guest',
		//				'INFORMATION_SCHEMA',
		//				'sys',
