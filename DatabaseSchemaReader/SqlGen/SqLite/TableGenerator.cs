...
namespace DatabaseSchemaMrg.SqlGen.SqLite
{
    class SqlLiteTableGenerator : TableGeneratorBase
    {
        public SqlLiteTableGenerator(DatabaseTable table)
            : base(table)
        {
        }
        ...
        protected override void AddTableConstraints(IList<string> columnList)
        {
            ...
            foreach (var foreignKey in Table.ForeignKeys)
            {
                ...
                if (referencedTable.PrimaryKey == null && referencedTable.FirstPrimaryKeyColumn != null)
                {
                    refColumnList = referencedTable.FirstPrimaryKeyColumn.Name;
                }
