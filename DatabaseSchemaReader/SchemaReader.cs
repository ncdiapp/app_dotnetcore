...
using DatabaseSchemaMrg.Utilities;
...
namespace DatabaseSchemaMrg
{
    ...
    ///</example>
    public partial class SchemaReader : IDisposable
    {
        ...
        /// </value>
        public EmSqlType? ProviderType { get; private set; }
		...
		public String CurrentUserSchemaOwner()
		{
		...
		public virtual string GetQueryCurrentUserSchemaOwner()
		{
			return string.Empty;
		}
        ...
        /// 
            ...
            // Som potinal bug here? //?????
		public virtual DataTable Tables()
        {
        ...
        protected virtual DataTable StoredProcedureArguments(string storedProcedureName, DbConnection connection)
        {
            ...
            else if (ProviderType == EmSqlType.Oracle) collectionName = "Arguments"; //Oracle, assume packages
        ...
        public DataTable PackageStoredProcedureArguments(string packageName)
        {
            using (DbConnection conn = Factory.CreateConnection())
            {
                ...
                string collectionName = ProcedureParametersCollectionName;
                if (ProviderType == EmSqlType.Oracle)
