...
namespace DatabaseSchemaMrg.DataSchema
{
    ...
    public partial class DatabaseTable : NamedSchemaObject
    {
		...
		public DatabaseColumn FirstPrimaryKeyColumn
		{
			get { return Columns.FirstOrDefault(c => c.IsPrimaryKey); }
		}

		public List<DatabaseColumn> PrimaryKeyColumnList
		{
			get { return Columns.Where(c => c.IsPrimaryKey).ToList (); }
		}

		public bool IsPrimaryKeyAutoNumber
		{
			get { return PrimaryKeyColumnList.Where (o=>o.IsAutoNumber).Count() >0 ; }
		}
        ...
        public int? DataSourceRegisterId
        {
            get;
            set;
        }
        ...
        private Dictionary<string, DatabaseColumn> _DictDataBaseColumn;
        /// <summary>
        /// Finds the column.
        /// </summary>
        /// <param name="name">The name.</param>
        ...
        public  Dictionary<string, DatabaseColumn> DictDataBaseColumn
        {
            get
            {
                if (_DictDataBaseColumn == null)
                {
                    _DictDataBaseColumn = Columns.ToDictionary(o => o.Name, o => o);
                    return _DictDataBaseColumn;
                }
                else
                {
                    return _DictDataBaseColumn;
        ...
        /// <summary>
        /// Get all column exclue Exclude Auto TimeStamp And Computed
        /// </summary>
