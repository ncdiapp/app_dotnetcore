...
namespace DatabaseSchemaMrg.Data
{
    ...
    public class Reader
    {
        ...
        private EmSqlType FindSqlType()
        {
            var sqlType = ProviderToSqlType.Convert(_providerName);
            return !sqlType.HasValue ? EmSqlType.SqlServer : sqlType.Value;
        }
        ...
        public DataTable Read()
        {
            ...
            var dbFactory = Utilities.FactoryTools.GetFactory(_providerName);
            using (var con = dbFactory.CreateConnection())
            {
                ...
                using (var cmd = con.CreateCommand())
                {
                    ...
                    if (sqlType == EmSqlType.SqlServerCe) parameterName = "offset";
                    p.ParameterName = parameterName;
                    p.Value = 1;
                    if (sqlType == EmSqlType.SqlServerCe) p.Value = 0;
