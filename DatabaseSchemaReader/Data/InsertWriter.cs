...
namespace DatabaseSchemaMrg.Data
{
    ...
    public class InsertWriter
    {
        ...
        public InsertWriter(DatabaseTable databaseTable, EmSqlType sqlType)
        {
        ...
        /// <param name="sqlType">Type of the SQL.</param>
        /// <returns></returns>
        public string Write(EmSqlType sqlType)
        {
        ...
        {
            if (!IncludeIdentity || (_sqlType != EmSqlType.SqlServer && _sqlType != EmSqlType.SqlServerCe) ||
        ...
        private void ResetIdentity(StringBuilder sb)
        {
            ...
            if (_sqlType != EmSqlType.SqlServer && _sqlType != EmSqlType.SqlServerCe) return;
            ...
            sb.AppendLine("GO");
            if (_sqlType == EmSqlType.SqlServer)
            {
