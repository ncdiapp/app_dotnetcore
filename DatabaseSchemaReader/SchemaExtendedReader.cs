...
namespace DatabaseSchemaMrg
{
    ...
    /// </summary>
    internal partial class SchemaExtendedReader : SchemaReader
    {
		...
		//protected List<DbParameter> AddTableNameSchemaParameters(string tableName)
		//{
