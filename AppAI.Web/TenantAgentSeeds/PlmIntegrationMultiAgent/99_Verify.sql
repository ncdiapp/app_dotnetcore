...
WHERE LibraryKey IN (
  N'platform-multi-agent', N'integration-plm-import', N'platform-app-config-pack',
...
PRINT '=== Agents ===';
SELECT SkillKey, DisplayName, ExecutionMode, IsActive, LEN(SystemPrompt) AS PromptLen
FROM dbo.AppAgentSkillSet
WHERE SkillKey IN (N'plm-integration-orchestrator', N'plm-integration-import-dw', N'app-config-pack-orchestrator')
ORDER BY SkillKey;
