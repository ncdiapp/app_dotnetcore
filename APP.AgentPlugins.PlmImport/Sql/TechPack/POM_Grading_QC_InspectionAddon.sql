-- PRODUCT ASSET: APP.AgentPlugins.PlmImport/Sql/TechPack/
-- Runtime source for ensure_techpack_schema. Not Document/Design drafts.
-- Copied from design draft; edit THIS file for product DDL going forward.
-- ============================================================
