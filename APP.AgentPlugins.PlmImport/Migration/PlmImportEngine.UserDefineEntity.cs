...
namespace APP.AgentPlugins.PlmImport
{
    public static partial class PlmImportEngine
    {
            ...
            string entityWideTablePrefix)
        {
            ...
            try
            {
                // dataSourceDiscoveryJson reserved for future DS-aware UD import; Host resolves tenant DB name.
                _ = dataSourceDiscoveryJson;
                ...
                if (string.IsNullOrWhiteSpace(tenantDbName))
                {
                    ...
                    preview.ErrorMessage = "Tenant database name could not be resolved from AppDataSourceRegister.";
                    return preview;
                }

                // Same-assembly User Define preview builder.
                return UserDefineEntityPreviewBuilder.Build(
                    plmConnectionString,
