    ...
    public static partial class PlmImportEngine
    {
        ...
        public static OperationCallResult<PlmTemplateMappingGridDto> GetTemplateTabMappingGrid(int? sessionId)
        {
            ...
            try
            {
                ...
                if (!preview.IsSuccess)
                {
                    ...
                    result.ValidationResult.Items.Add(new ValidationItem(
                        typeof(PlmImportEngine), "Plm_Template_Grid_Error", ValidationItemType.Error, preview.ErrorMessage));
                    return result;
                }
            ...
            catch (Exception ex)
            {
                ...
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_Template_Grid_Error", ValidationItemType.Error, ex.Message));
            }
        ...
        public static OperationCallResult<PlmTemplateImportSettingDto> SaveTemplateMapping(int? sessionId, PlmTemplateImportSettingDto setting)
        {
            ...
            {
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_Template_Save_Error", ValidationItemType.Error, ex.Message));
            }
        ...
        public static OperationCallResult<PlmTemplateMappingValidationDto> ValidateTemplateMapping(int? sessionId, PlmTemplateImportSettingDto setting)
        {
            ...
            catch (Exception ex)
            {
                ...
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_Template_Validate_Error", ValidationItemType.Error, ex.Message));
            }
