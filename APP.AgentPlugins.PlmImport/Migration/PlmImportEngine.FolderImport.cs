    ...
    public static partial class PlmImportEngine
    {
        ...
        public static OperationCallResult<PlmFolderImportPreviewDto> PreviewPlmFolderImport(int? sessionId)
        {
            ...
            try
            {
                ...
                if (!result.Object.IsSuccess)
                {
                    result.ValidationResult.Items.Add(new ValidationItem(
                        typeof(PlmImportEngine), "Plm_Folder_Preview_Error", ValidationItemType.Error,
            ...
            catch (Exception ex)
            {
                ...
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_Folder_Preview_Error", ValidationItemType.Error, ex.Message));
            }
        ...
        public static OperationCallResult<PlmImportJobDto> StartPlmFolderImportJob(int? sessionId)
        {
            ...
            {
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_Folder_Execute_Error", ValidationItemType.Error, ex.Message));
            }
