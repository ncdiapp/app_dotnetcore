    ...
    public static partial class PlmImportEngine
    {
        ...
        public static OperationCallResult<PlmTemplatePreviewDto> PreviewTemplateMapping(int? sessionId)
        {
            ...
            try
            {
                ...
                if (!result.Object.IsSuccess)
                {
                    result.ValidationResult.Items.Add(new ValidationItem(
                        typeof(PlmImportEngine), "Plm_Template_Preview_Error", ValidationItemType.Error,
                ...
                else if (result.Object.BlockerCount > 0)
                {
                    ...
                    result.ValidationResult.Items.Add(new ValidationItem(
                        typeof(PlmImportEngine), "Plm_Template_Preview_Blocker", ValidationItemType.Warning,
            ...
            catch (Exception ex)
            {
                ...
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_Template_Preview_Error", ValidationItemType.Error, ex.Message));
            }
            return result;
        }
