    ...
    public static partial class PlmImportEngine
    {
        ...
        public static OperationCallResult<PlmFolderPlacementPreviewDto> PreviewPlmFolderPlacement(int? sessionId)
        {
            ...
            try
            {
                ...
                if (!result.Object.IsSuccess)
                {
                    result.ValidationResult.Items.Add(new ValidationItem(
                        typeof(PlmImportEngine), "Plm_FolderPlacement_Preview_Error", ValidationItemType.Error,
            ...
            catch (Exception ex)
            {
                ...
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_FolderPlacement_Preview_Error", ValidationItemType.Error, ex.Message));
            }
        ...
        public static OperationCallResult<PlmImportJobDto> StartPlmFolderPlacementJob(int? sessionId)
        {
            ...
            {
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_FolderPlacement_Execute_Error", ValidationItemType.Error, ex.Message));
            }
