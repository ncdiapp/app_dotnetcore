    ...
    public static partial class PlmImportEngine
    {
        public static OperationCallResult<PlmSystemDefineEntityPreviewDto> PreviewSystemDefineEntityImport(int? sessionId)
        {
            ...
            try
            {
                ...
                if (!result.Object.IsSuccess)
                {
                    result.ValidationResult.Items.Add(new ValidationItem(
                        typeof(PlmImportEngine), "Plm_SystemDefine_Preview_Error", ValidationItemType.Error,
                ...
                else if (result.Object.BlockerCount > 0)
                {
                    ...
                    result.ValidationResult.Items.Add(new ValidationItem(
                        typeof(PlmImportEngine), "Plm_SystemDefine_Preview_Blocker", ValidationItemType.Warning,
            ...
            catch (Exception ex)
            {
                ...
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_SystemDefine_Preview_Error", ValidationItemType.Error, ex.Message));
            }
            return result;
        }
        ...
        public static OperationCallResult<PlmUserDefineEntityPreviewDto> PreviewUserDefineEntityImport(int? sessionId)
        {
            ...
            try
            {
                ...
                {
                    result.ValidationResult.Items.Add(new ValidationItem(
                        typeof(PlmImportEngine), "Plm_UserDefine_Preview_Error", ValidationItemType.Error,
                        result.Object.ErrorMessage));
                }
                else if (result.Object.BlockerCount > 0)
                {
                    WriteUserDefineEntityIssuesToLog(
                        ...
                        null, result.Object.Blockers);
                    result.ValidationResult.Items.Add(new ValidationItem(
                        typeof(PlmImportEngine), "Plm_UserDefine_Preview_Blocker", ValidationItemType.Warning,
            ...
            catch (Exception ex)
            {
                ...
                result.Object.ErrorMessage = ex.Message;
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_UserDefine_Preview_Error", ValidationItemType.Error, ex.Message));
            }
            return result;
        }
        ...
        private static OperationCallResult<PlmImportJobDto> ExecuteStubJob(int? sessionId, string jobType, string message)
        {
            ...
            {
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_Entity_Execute_Error", ValidationItemType.Error, ex.Message));
            }
            return result;
        }
    }
