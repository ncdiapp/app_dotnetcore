...
UPDATE dbo.AppPlmImportJob SET
    ...
    UpdatedAt = @UpdatedAt");
        ...
        public static OperationCallResult<PlmImportJobDto> StartPlmTableExportJob(int? sessionId)
        {
            ...
            catch (Exception ex)
            {
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_TableExport_Start_Error", ValidationItemType.Error, ex.Message));
            }
            return result;
        }
        ...
        public static OperationCallResult<PlmImportJobDto> StartSystemDefineEntityImportJob(int? sessionId)
        {
            ...
            {
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_SystemDefine_Execute_Error", ValidationItemType.Error, ex.Message));
            }
            return result;
        }
        ...
        public static OperationCallResult<PlmImportJobDto> StartUserDefineEntityImportJob(int? sessionId)
        {
            ...
            {
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_UserDefine_Execute_Error", ValidationItemType.Error, ex.Message));
            }
            return result;
        }
        ...
        public static OperationCallResult<PlmImportJobDto> StartTemplateImportJob(int? sessionId)
        {
            ...
            {
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_Template_Execute_Error", ValidationItemType.Error, ex.Message));
            }
            return result;
        }
        ...
        public static OperationCallResult<PlmTableExportPlanDto> PreviewPlmTableExportPlan(int? sessionId)
        {
            ...
            try
            {
                ...
                {
                    result.ValidationResult.Items.Add(new ValidationItem(
                        typeof(PlmImportEngine), "Plm_TableExport_Preview_Error", ValidationItemType.Error,
                ...
                else
                {
                    if (result.Object.Issues?.Count > 0)
                    {
                        ...
                        result.ValidationResult.Items.Add(new ValidationItem(
                            typeof(PlmImportEngine), "Plm_TableExport_Preview_Warning", ValidationItemType.Warning,
                            result.Object.ErrorMessage));
                    }
                }
            }
            catch (Exception ex)
            {
                ...
                result.ValidationResult.Items.Add(new ValidationItem(
                    typeof(PlmImportEngine), "Plm_TableExport_Preview_Error", ValidationItemType.Error, ex.Message));
            }
            return result;
        }
    }
